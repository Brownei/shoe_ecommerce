...
const ProductList = ({ products }) => {
  ...
  return (
    <div className='each-product container mx-auto p-4 flex flex-wrap justify-center items-center space-x-0 space-y-3 z-20 md:space-x-3'>
      {products.map((product) => (
       <div className='relative flex flex-col justify-center items-start border rounded-2xl pb-5 shadow-sm duration-200 hover:scale-105 bg-[#F6F6F6] md:w-1/3 lg:w-1/4' key={product.id} >
